...
export const WhitelistStep = () => {
  ...
  return (
    <WizardStep title="Add whitelisted assets to your DAO" subTitle="(Optional) Only whitelisted assets will appear in a DAO's treasury. After this step, the only way to update a whitelist is through governance.">
      <VStack gap={24}>
